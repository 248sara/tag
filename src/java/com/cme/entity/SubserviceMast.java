...
@NamedQueries({
    ...
    @NamedQuery(name = "SubserviceMast.portalServices", query = "SELECT s FROM SubserviceMast s WHERE s.ssrvCode <> :ssrvCode AND s.ssrvSrtCode = :ssrvSrtCode")})
public class SubserviceMast implements Serializable {
    ...
    public BigDecimal getSsrvTariff() {
        return ssrvTariff;
    }

    public void setSsrvTariff(BigDecimal ssrvTariff) {
    ...
    public String toString() {
        return "com.cme.entity.SubserviceMast[ ssrvCode=" + ssrvCode + " ]";
    }
